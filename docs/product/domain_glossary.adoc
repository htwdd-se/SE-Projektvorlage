...
Es beschreibt die Realität des Problemraums, nicht die Datenbankstruktur. Für Klassen, die zeitnah implementiert werden sollen, können Attribute und Datentypen definiert werden. Somit entsteht ein partielles logisches Datenmodell._
